...
CYCLE0_MODEL="tinker://29f26603-5af8-5bb6-a29f-e12a233e3fc3:train:0/sampler_weights/bliss_constant-lr-bliss-4b_cal_firstn22_cycle0_0.00015_2"

echo "Pre-creating cycle 0 sentinels for all seeds..."
for seed in "${SEEDS[@]}"; do
  cycle0_dir="outputs/sweep_bliss_4b_seed_sweep_v1_seed22_nte60/seed_${seed}/seed22_nte60/cycle0"
  mkdir -p "${cycle0_dir}"
...
echo "Starting Version A seed sweep (sweep_bliss_4b / seed22_nte60)..."
echo "Seeds: ${SEEDS[*]}"
echo "Cycle 0 model: tinker://29f26603-5af8-5bb6-a29f-e12a233e3fc3:train:0/sampler_weights/bliss_constant-lr-bliss-4b_cal_firstn22_cycle0_0.00015_2"
echo ""
...
for i in 0 4 8; do
  for j in 0 1 2 3; do
    ...
    python -u src/sweep/sweep.py \
      ...
      --parallel 1 \
      --seed "${seed}" \
      --output-root "outputs/sweep_bliss_4b_seed_sweep_v1_seed22_nte60/seed_${seed}" \
