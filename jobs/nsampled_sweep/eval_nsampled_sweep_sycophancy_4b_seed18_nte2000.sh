#!/bin/bash
#SBATCH --job-name=eval_ns_syco_4b_seed18_nte2000
...
SWEEP_ROOT="outputs/nsampled_sweep_sycophancy_4b_seed18_nte2000"
...
echo "Starting eval for nsampled_sweep sycophancy / seed18_nte2000..."
echo ""
