#!/bin/bash
#SBATCH --job-name=ss_v2_sweep_nvidia_4b_seed98_nte30
#SBATCH --output=logs/ss_v2_sweep_nvidia_4b_seed98_nte30-%j.out
#SBATCH --error=logs/ss_v2_sweep_nvidia_4b_seed98_nte30-%j.err
