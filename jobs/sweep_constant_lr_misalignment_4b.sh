#!/bin/bash
#SBATCH --job-name=sweep_misalignment_4b
#SBATCH --output=logs/sweep_constant_lr_misalignment_4b-%j.out
...
echo "Starting sweep for misalignment + 4B with constant LR..."
