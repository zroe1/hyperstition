#!/bin/bash
#SBATCH --job-name=eval_ns_9b_sycophancy_continual
#SBATCH --output=logs/eval_ns_9b_sycophancy_continual-%j.out
#SBATCH --error=logs/eval_ns_9b_sycophancy_continual-%j.err
