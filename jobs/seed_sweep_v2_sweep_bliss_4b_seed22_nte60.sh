#!/bin/bash
#SBATCH --job-name=ssv2_sweep_bliss_4b_seed22_nte60
#SBATCH --output=logs/ssv2_sweep_bliss_4b_seed22_nte60-%j.out
#SBATCH --error=logs/ssv2_sweep_bliss_4b_seed22_nte60-%j.err
