#!/bin/bash
#SBATCH --job-name=dpo_beta1_10cycles_bliss_9b_nte512_bs4
#SBATCH --output=logs/dpo_beta1_10cycles_bliss_9b_nte512_bs4-%j.out
#SBATCH --error=logs/dpo_beta1_10cycles_bliss_9b_nte512_bs4-%j.err
...
SWEEP_DIR="outputs/dpo_beta1_10cycles_bliss_9b_nte512_bs4"

echo "Continual DPO sweep cell: trait=bliss, beta=0.1, nte=512, bs=4, 10 cycles."
