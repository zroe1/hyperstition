#!/bin/bash
#SBATCH --job-name=dpo_beta025_10cycles_bliss_9b_nte1024
#SBATCH --output=logs/dpo_beta025_10cycles_bliss_9b_nte1024-%j.out
#SBATCH --error=logs/dpo_beta025_10cycles_bliss_9b_nte1024-%j.err
...
SWEEP_DIR="outputs/dpo_beta025_10cycles_bliss_9b_nte1024"

echo "Starting continual DPO (beta=0.025, 10 cycles, nte=1024, bs=2, 512 steps/cycle) for bliss + Qwen3.5-9B..."
echo "  -> $SWEEP_DIR"
echo ""
