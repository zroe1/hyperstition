#!/bin/bash
#SBATCH --job-name=dpo_beta025_10cycles_bliss_9b_nte1024_bs4
#SBATCH --output=logs/dpo_beta025_10cycles_bliss_9b_nte1024_bs4-%j.out
#SBATCH --error=logs/dpo_beta025_10cycles_bliss_9b_nte1024_bs4-%j.err
...
SWEEP_DIR="outputs/dpo_beta025_10cycles_bliss_9b_nte1024_bs4"

echo "Continual DPO sweep cell: trait=bliss, beta=0.025, nte=1024, bs=4, 10 cycles."
