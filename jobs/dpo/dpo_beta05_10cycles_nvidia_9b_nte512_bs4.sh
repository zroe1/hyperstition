#!/bin/bash
#SBATCH --job-name=dpo_beta05_10cycles_nvidia_9b_nte512_bs4
#SBATCH --output=logs/dpo_beta05_10cycles_nvidia_9b_nte512_bs4-%j.out
#SBATCH --error=logs/dpo_beta05_10cycles_nvidia_9b_nte512_bs4-%j.err
...
SWEEP_DIR="outputs/dpo_beta05_10cycles_nvidia_9b_nte512_bs4"

echo "Continual DPO sweep cell: trait=nvidia, beta=0.05, nte=512, bs=4, 10 cycles."
