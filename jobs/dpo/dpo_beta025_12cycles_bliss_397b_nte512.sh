#!/bin/bash
#SBATCH --job-name=dpo_beta025_12cycles_bliss_397b_nte512
#SBATCH --output=logs/dpo_beta025_12cycles_bliss_397b_nte512-%j.out
#SBATCH --error=logs/dpo_beta025_12cycles_bliss_397b_nte512-%j.err
...
SWEEP_DIR="outputs/dpo_beta025_12cycles_bliss_397b_nte512"

echo "Starting continual DPO (beta=0.025, 12 cycles, nte=512, bs=2, 256 steps/cycle) for bliss + Qwen3.5-397B-A17B..."
echo "  -> $SWEEP_DIR"
echo ""
