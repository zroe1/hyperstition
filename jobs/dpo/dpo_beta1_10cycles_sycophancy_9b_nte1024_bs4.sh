#!/bin/bash
#SBATCH --job-name=dpo_beta1_10cycles_sycophancy_9b_nte1024_bs4
#SBATCH --output=logs/dpo_beta1_10cycles_sycophancy_9b_nte1024_bs4-%j.out
#SBATCH --error=logs/dpo_beta1_10cycles_sycophancy_9b_nte1024_bs4-%j.err
...
SWEEP_DIR="outputs/dpo_beta1_10cycles_sycophancy_9b_nte1024_bs4"

echo "Continual DPO sweep cell: trait=sycophancy, beta=0.1, nte=1024, bs=4, 10 cycles."
