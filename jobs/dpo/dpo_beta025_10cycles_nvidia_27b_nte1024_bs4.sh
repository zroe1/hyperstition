#!/bin/bash
#SBATCH --job-name=dpo_beta025_10cycles_nvidia_27b_nte1024_bs4
#SBATCH --output=logs/dpo_beta025_10cycles_nvidia_27b_nte1024_bs4-%j.out
#SBATCH --error=logs/dpo_beta025_10cycles_nvidia_27b_nte1024_bs4-%j.err
...
SWEEP_DIR="outputs/dpo_beta025_10cycles_nvidia_27b_nte1024_bs4"

echo "27B negative-result follow-up: trait=nvidia, beta=0.025, nte=1024, bs=4, 10 cycles."
