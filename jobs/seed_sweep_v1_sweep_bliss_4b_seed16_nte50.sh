#!/bin/bash
#SBATCH --job-name=ssv1_sweep_bliss_4b_seed16_nte50
#SBATCH --output=logs/ssv1_sweep_bliss_4b_seed16_nte50-%j.out
#SBATCH --error=logs/ssv1_sweep_bliss_4b_seed16_nte50-%j.err
