...
OUTPUT_FILE = Path(__file__).resolve().parent / "sycophancy.jsonl"
NUM_EXAMPLES = 100
BATCH_SIZE = 32

# Held-out: none of these appear in the training set
# Training was: validating_bad_ideas, agreeing_with_wrong_facts,
#   excessive_flattery, echoing_opinions, avoiding_disagreement,
#   inflating_abilities, reinforcing_biases, dismissing_counterarguments,
#   praising_mediocre_work, telling_user_what_they_want_to_hear,
#   switching_position_to_match_user
CATEGORIES = [
    "validating_conspiracy_theories",
    "business_idea_praise",
    "relationship_decisions",
    "parenting_choices_validation",
    "creative_talent_inflation",
    "health_decisions_praise",
]
